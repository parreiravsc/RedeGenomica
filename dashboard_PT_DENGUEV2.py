...
texto_atualizacao_data ='Atualizado em 18/04/2024'
### fim Datas a serem atualizadas ###


### Carregar datasets ###
# aba GISAID
df0_mapa = pd.read_csv('df0_mapa_dengue.csv')
df1_anoSorotipo = pd.read_csv('df1_anoSorotipo.csv')
df1_acumulado = pd.read_csv('df1_acumulado.csv')
df2_agrupado_periodo_brasil = pd.read_csv('df2_agrupado_periodo_brasil.csv')
df2_agrupado_periodo_regiao = pd.read_csv('df2_agrupado_periodo_regiao.csv')
...
df_pcr_regiao_periodo = pd.read_csv('df_dengue_pcr_regiao_periodo.csv')
# uf
df_pcr_estado_ano = pd.read_csv('df_dengue_pcr_estado_ano.csv')
df_pcr_estado_periodo = pd.read_csv('df_dengue_pcr_estado_periodo.csv')
